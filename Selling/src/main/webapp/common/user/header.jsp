			...
			<div class="input-group">
				...
				<span class="input-group-append">
					<button
						...
						type="submit" style="padding: 0px; margin: 0px">
		...
		<c:if test="${sessionScope.account != null}">
			<div class="d-flex align-items-center">
				<a href="<c:url value='/user/findCartByCartID?cartID=${cartID}'/>"
					...
					class="fas fa-shopping-cart" style="padding-right: 50px;">(${countCartItem})</i>
				</a>
				<div class="nav-item dropdown pe-3" style="list-style: none;">
					<a class="nav-link nav-profile d-flex align-items-center pe-0"
						href="#" data-bs-toggle="dropdown" aria-expanded="true"> <img
						...
						class="d-none d-md-block dropdown-toggle ps-2">${customer.customerName}
					</span>
					</a>
