    ...
    <form action="updatepro" method="post">
        ...
        <div class="modal-body">	
        	<div class="form-group">
                ...
                <input name="productId" type="text" class="form-control" value="${product.productId}" readonly="readonly" required>
            </div>				
            <div class="form-group">
            ...
            <div class="form-group">
                <label>Amount</label>
                <input name="amount" type="number" class="form-control" value="${product.amount}"  required></input>
            </div>
            <div class="form-group">
                <label>Price</label>
                <input name="price" type="number" class="form-control" value="${product.price}"  required></input>
            </div>
            <div class="form-group">
                <label>Image URL</label>
                <input name="imageURL"  type ="text" class="form-control" value="${product.imageURL}"  required></input>
            </div>
            <div class="form-group">
