    ...
    <div class="container">
      <div class="user__list" style="margin-top: 35px">
        <ul class="list-group">
          ...
          <a style="text-decoration: none" href="findCartByCartID"
            ><li
              class="list-group-item list-group-item-action list-group-item-primary"
            >
              <i class="fas fa-gift"></i>Giỏ hàng
            </li>
          </a>
          <li
              ...
              <fieldset class="row mb-3">
                ...
                <div class="col-sm-10">
                  <div class="form-check form-check-inline">
                    ...
                    id="gridRadios1" value="Nam" ${customer.gender == 'Nam' ?
                    'checked' : ''}>
                  ...
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="gender"
                    id="gridRadios2" value="Nữ" ${customer.gender == 'Nữ' ?
                    'checked' : ''}>
