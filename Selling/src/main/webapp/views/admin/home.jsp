  ...
  <body>
        ...
        >
          <li class="nav-item">
            <a href="home" class="nav-link align-middle px-0 nav-menu">
              ...
              ></i>
              <span class="d-none d-sm-inline" style="margin-left: 10px"
                >Trang chủ</span
              >
            </a>
          </li>
    ...
    <script>
      ...
      function createChart(statistisData) {
        var revenueJSON = decodeURIComponent(
          '<c:out value="${revenueJSON}" />'
        );
      ...
      document.addEventListener("DOMContentLoaded", function () {
        createChart(
          JSON.parse("[10, 20, 15, 25, 30, 45, 75, 55, 100, 66, 47, 78]")
        );
      });
