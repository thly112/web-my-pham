  ...
  <body>
    <div class="d-flex mt-4">
      ...
      >
        ...
        >
          <li class="nav-item">
            <a href="home" class="nav-link align-middle px-0 nav-menu">
              <i
                class="fal fas fa-home"
                style="color: #7097db; font-size: 30px"
              ></i>
              <span
                class="d-none d-sm-inline"
                style="margin-left: 10px; color: #212529"
                >Trang chủ</span
              >
            </a>
          </li>
          ...
          <li>
            <a href="listuser" class="nav-link align-middle px-0 nav-menu">
              <i
                class="fal fas fa-users"
                style="color: #c77070; font-size: 30px"
              ></i>
              <span
                class="d-none d-sm-inline"
                style="margin-left: 9px; color: #212529"
                >Khách hàng</span
              >
            </a>
          </li>
          ...
          <li>
            <a href="listseller" class="nav-link align-middle px-0 nav-menu">
              <i
                class="far fas fa-user"
                style="color: #178254; font-size: 30px"
              ></i>
              <span
                class="d-none d-sm-inline"
                style="margin-left: 19px; color: #212529"
                >Nhân Viên</span
              >
            </a>
          </li>
          ...
          <li>
            <a href="listshipper" class="nav-link align-middle px-0 nav-menu">
              <i
                class="fal fas fa-shipping-fast"
                style="color: #592731; font-size: 30px"
              ></i>
              <span class="d-none d-sm-inline" style="margin-left: 9px"
                >Shipper</span
              >
            </a>
          </li>
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-6">
              <div class="mb-3">
                <h5 class="card-title">
                  Thông tin Shipper<span class="text-muted fw-normal ms-2"
                    >(${count })</span
                  >
                </h5>
              </div>
                      ...
                      <c:forEach var="i" items="${list}">
                        <tr>
                          ...
                          <td>
                            ...
                            />
                            <a
                              href="shipperdetail?id=${i.employeeId }"
                              class="text-body"
                              >${i.employeeName}</a
                            >
                          </td>
                ...
                <ul class="pagination mb-sm-0">
                  <c:if test="${page<=1 }">
                    <li class="page-item disabled">
                      <a href="listshipper?page=${page - 1}" class="page-link"
                  ...
                  <c:forEach var="i" begin="1" end="${num }">
                    <c:if test="${i==page }">
                      <li class="page-item active">
                        <a href="listshipper?page=${i}" class="page-link"
                          >${i }</a
                        >
                      </li>
                    </c:if>
