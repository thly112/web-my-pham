      ...
      <div class="container d-flex content">
        ...
        <div class="tab-content" id="v-pills-tabContent">
                  ...
                  <c:forEach var="i" items="${listorder}">
                    <div class="product">
                      <div class="product-detail rounded d-flex">
                        <div class="content-info ml-2">
                          <div class="product-id" href="">
                            <i class="fa-solid fa-qrcode"></i>Mã đơn hàng:
                            ${i.orderID }
                          </div>
                      ...
                      <div class="product-address d-flex">
                        <div
                          class="content-info ml-2 mb-2 justify-content-between"
                        >
                          <div class="address">
                      ...
                      <div class="product-button d-flex">
                        <c:if test="${i.orderStatus == 'Đã giao khách hàng' }">
                          <button
                            ...
                            style="margin-left: 920px; margin-bottom: 20px"
                            disabled
                          >
                            <i
                        ...
                        <ul class="pagination mb-sm-0">
                          <c:if test="${page<=1 }">
                            <li class="page-item disabled">
                              <a href="home?page=${page - 1}" class="page-link"
                          ...
                          <c:forEach var="i" begin="1" end="${num }">
                            <c:if test="${i==page }">
                              <li class="page-item active">
                                <a href="home?page=${i}" class="page-link"
                                  >${i }</a
                                >
                              </li>
                            </c:if>
                    ...
                    <div class="product">
                      ...
                      <div class="product-address d-flex">
                        ...
                        >
                          ...
                          <div class="name">
                            Họ và tên: ${i.customer.customerName }
                          </div>
                        </div>
                        <div class="product-status text-center">
                          <p><i class="fa-solid fa-flag"></i>Trạng thái</p>
                      ...
                      <div class="float-sm-end">
                        <ul class="pagination mb-sm-0">
                          ...
                          <c:forEach var="i" begin="1" end="${num1 }">
                            <c:if test="${i==page1 }">
                              <li class="page-item active">
                                <a href="home?page1=${i}" class="page-link"
                                  >${i }</a
                                >
                              </li>
                            </c:if>
                      ...
                      <div class="float-sm-end">
                        <ul class="pagination mb-sm-0">
                          ...
                          <c:forEach var="i" begin="1" end="${num2}">
                            <c:if test="${i==page2 }">
                              <li class="page-item active">
                                <a href="home?page2=${i}" class="page-link"
                                  >${i }</a
                                >
                              </li>
                            </c:if>
          ...
          <div
            ...
            role="tabpanel"
            aria-labelledby="v-pills-profile-information"
            tabindex="0"
          >
            <div
            ...
            >
              ...
              <div class="col-lg-6 px-xl-10">
                <form action="updateinfor" method="post">
                  ...
                  >
                    <h3 class="h2 text-white text-center mb-0">
                      ${shipper.employeeName }
                    </h3>
                  </div>
                  <ul class="list-unstyled mb-1-9">
                    ...
                    <li class="mb-2 mb-xl-3 d-flex align-items-center">
                      <label
                        ...
                        class="display-26 text-secondary me-2 font-weight-600 form-label"
                        >Họ và tên:</label
                      >
                      <input
                        type="text"
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              Bạn có muốn chuyển trạng thái sang "Đã giao hàng"
            </div>
    ...
    <script>
      ...
      document.addEventListener("DOMContentLoaded", function () {
        ...
        products.forEach(function (product) {
          ...
          product.querySelector(".product-detail").style.backgroundColor =
            currentColor;
          product.querySelector(".product-address").style.backgroundColor =
            currentColor;
          product.querySelector(".product-button").style.backgroundColor =
            currentColor;
        });
